...
public class BackendApplication {
	...
	public CommandLineRunner mappingDemo(
		...
		return args -> {
			...
			asesoriaRepository.save(new Asesoria(Long.valueOf(0),dateFormat.parse("2024-10-23"),12.50,dateFormat.parse("2024-10-25"),4,2,AsesoriaEstado.CANCELADA,Time.valueOf("10:00:00"),Time.valueOf("11:00:00"),1,12.50,alumnoRepository.findByNombreContaining("Jhon").get(0),asesorRepository.findByNombreContaining("Uriel").get(0),cursoRepository.findByNombreContaining("lengua").get(0)));
