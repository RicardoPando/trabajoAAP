...
public class AsesorCursoController {
    ...
    @GetMapping("/asesor_cursos/cursos/{id_cursos}")
    ...
    @GetMapping("/asesor_cursos/cursos/asesor/{id_asesor}")
    ...
    @GetMapping("/asesor_cursos/asesor/cursos/{id_cursos}")
    public ResponseEntity<List<Asesor>> getAsesorByCurso_Id(@PathVariable("id_cursos") Long id) {
    ...
    //eliminar
    @DeleteMapping("/asesor_cursos/{id}")
